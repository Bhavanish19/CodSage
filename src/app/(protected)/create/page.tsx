            ...
            <div>
                <div>
                    ...
                    <p className='text-sm text-muted-foreground'>
                        Enter the URL of your GitHub repository to link it to Codesage.
                    </p>
                </div>
                ...
                <div>
                    <form onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <div className="h-4"></div>
                        {/* <Button type="submit" disabled={!hasEnoughCredits || linkRepo.isPending || checkCredits.isPending}>
                            {linkRepo.isPending || checkCredits.isPending ? "Processing..." : checkCredits.data ? "Create Project" : "Check Credits"}
